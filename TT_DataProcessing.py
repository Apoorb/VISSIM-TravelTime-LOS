...
PivFun(Mer_Dat[Mer_Dat["Year"]==2025],"SMS").to_excel(writer,"SMS2025")
PivFun(Mer_Dat[Mer_Dat["Year"]==2025],"TotalDelay").to_excel(writer,"TotDelay2025")
PivFun(Mer_Dat[Mer_Dat["Year"]==2025],"VEHS(ALL)").to_excel(writer,"Throughput2025")
PivFun(Mer_Dat[Mer_Dat["Year"]==2045],"SMS").to_excel(writer,"SMS2045")
PivFun(Mer_Dat[Mer_Dat["Year"]==2045],"TotalDelay").to_excel(writer,"TotDelay2045")
PivFun(Mer_Dat[Mer_Dat["Year"]==2045],"VEHS(ALL)").to_excel(writer,"Throughput2045")
