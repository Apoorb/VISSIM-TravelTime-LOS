...
ListFiles=glob.glob("D:/Dropbox/TTI_Projects/Road User Cost/VISSIM PM Peak V14/NB/NB 2045/*.inpx")
Lfs3=glob.glob("D:/Dropbox/TTI_Projects/Road User Cost/VISSIM PM Peak V14/NB/NB 2025/*.inpx")
ListFiles=ListFiles+Lfs3
